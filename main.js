...
var require_dist = __commonJS({
  "node_modules/@marijn/find-cluster-break/dist/index.cjs"(exports) {
    "use strict";
    var rangeFrom = [];
    var rangeTo = [];
    (() => {
...
var require_dist3 = __commonJS({
  "node_modules/crelt/dist/index.cjs"(exports, module2) {
    "use strict";
    function crelt() {
      var elt = arguments[0];
  ...
  "node_modules/@codemirror/view/dist/index.cjs"(exports) {
    ...
    function runHandlers(map, event, view, scope) {
      ...
      if (scopeObj) {
        ...
        !(browser.mac && event.altKey && !event.ctrlKey) && (baseName = w3cKeyname.base[event.keyCode]) && baseName != name) {
    ...
    var gutterView = ViewPlugin.fromClass(class {
      ...
      provide: (plugin2) => EditorView.scrollMargins.of((view) => {
        ...
        return view.textDirection == exports.Direction.LTR ? { left: before, right: after } : { right: before, left: after };
      })
    });
...
var ToggleableTablesPlugin = class extends import_obsidian.Plugin {
  ...
  createHybridEditExtension() {
    const { EditorView } = require_dist4();
    const { StateField, StateEffect } = require_dist2();
